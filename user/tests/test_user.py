...
class UserTests(TestCase):
    ...
    def test_login_view(self):
        response = self.client.post(self.login_url, {'username': 'testuser@example.com', 'password': 'testpassword123'})
    ...
    def test_artist_profile_view(self):
        self.client.login(username='testuser@example.com', password='testpassword123')
        response = self.client.get(reverse('artist-profile', kwargs={'user_id': self.user.id}))
